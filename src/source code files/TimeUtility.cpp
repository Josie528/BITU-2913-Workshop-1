...
time_t TimeFunc::userInputToTime_t(int year, int month, int day) {
	tm t;
	time_t rawtime = time(0);
...
time_t TimeFunc::userInputToTime_t(int year, int month, int day, int hour_24, int minute, int seconds) {
	tm t;
	time_t rawtime = time(0);
